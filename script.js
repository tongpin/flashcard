// ==========================================
// 1. ទិន្នន័យសំណួរ និងចម្លើយទាំង ៦៤ (Data)
// ==========================================
const biologyQuestions = [
  ...
  { id: 64, question: "តើបំរែបំរួលអាកាសធាតុបណ្តាលមកពីបាតុភូតអ្វីខ្លះ?", answer: "បណ្តាលមកពីកើនឡើងនៃឧស្ម័នផ្ទះកញ្ចក់ ($CO_2, CH_4$) ដែលធ្វើឱ្យកម្ដៅភពផែនដីកើនឡើង។" }
];
// ==========================================
...
// ==========================================
// 5. App Logic (Spin & Flashcard Logic)
// ==========================================
...
// មុខងារ Spin ជ្រើសរើសសំណួរដោយប្រឡោះ
...
// ដំណើរការ Progress ពេល Load ទំព័រដំបូង
updateProgressUI();
